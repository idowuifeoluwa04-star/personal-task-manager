  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-4 md:px-10 xl:px-[100px] 2xl:px-[170px] pt-10 md:pt-[60px] xl:pt-[81px] gap-8 md:gap-10">
        <div className="flex flex-col gap-4 sm:gap-5 md:gap-[21px] max-w-[535px] text-center md:text-left">
          ...
          <button
            ...
            className="w-full sm:w-fit mx-auto md:mx-0 rounded-[8px] bg-[#974FD0] hover:bg-[#7e3fb0] cursor-pointer text-[#FAF9FB] font-medium text-[16px] sm:text-[18px] md:text-[24px] px-[20px] py-[10px] md:px-[25px]"
          >
            Go to My Tasks
          </button>
        </div>
        <img
          ...
          className="w-[220px] h-[208px] sm:w-[320px] sm:h-[303px] md:w-[418.56px] md:h-[396.2px]"
        />
      </div>
    </div>
  );
